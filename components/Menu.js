...
const images={
  "1":require("../data1946/1946menu/1.png"),
  "2":require("../data1946/1946menu/2.png"),
  "4":require("../data1946/1946menu/4.png"),
  "3":require("../data1946/1946menu/3.png"),
  "5":require("../data1946/1946menu/5.png"),
  "6":require("../data1946/1946menu/6.png"),
  "7":require("../data1946/1946menu/7.png"),
  "8":require("../data1946/1946menu/8.png"),
  "9":require("../data1946/1946menu/9.png"),
  "10":require("../data1946/1946menu/10.png"),
  "11":require("../data1946/1946menu/11.png"),
  "12":require("../data1946/1946menu/12.png")
  }
  const titles={
    "1":"TẤM QUÀ 1930",
    "2":"PHỐ CHỢ 1932",
  ...
  renderLanguage(){
    if(this.state.lang=="VN"){
        ...
        <View style={{height:50,width:150,backgroundColor:'white',flexDirection:'row',marginRight:5,paddingLeft:6,alignItems:'center',marginTop:10,borderColor:'#6B2C24',borderWidth:2}} >
            ...
            <FastImage 
                source={require('../assets/icon/flag_england.png')}
        ...
        <View style={{height:50,width:150,backgroundColor:'white',flexDirection:'row',marginRight:5,paddingLeft:6,alignItems:'center',marginTop:10,borderColor:'#6B2C24',borderWidth:2}} >
            <FastImage 
                source={require('../assets/icon/flag_vn.png')}
                style={{height:35,width:55}}
            />
